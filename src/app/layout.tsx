        ...
        <header className=" p-4">
          ...
          >
            ...
            <div className="navbar-center hidden lg:flex">
              ...
              <div className="">
                <Link href="/login" className="btn font-semibold text-xl">
                  Log-In
                </Link>
              </div>
            </div>
            ...
            <div className="navbar-end" data-id="logo">
              <Link href="/" className="btn btn-ghost text-3xl font-bold">MedFinder</Link>
            </div>
          </div>
        </header>
